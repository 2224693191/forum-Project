...
// function init() {// 初始化函数,打开页面的时候去localStroage加载文章列表和文章分类列表，如果没有就用默认数据
//     // 初始化数据
//     let userFansRelation = JSON.parse(localStorage.getItem("userFansRelation"))
//     if (userFansRelation) {
//         data.userFansRelation = userFansRelation
//     }

// }
// function save() {// 保存文章列表，修改了文章里的内容后需要调用这个方法
//     localStorage.setItem("notifyList", JSON.stringify(data.notifyList))
// }
